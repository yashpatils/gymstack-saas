...
export function PlatformHeader({ leftSlot, centerSlot, rightSlot }: { leftSlot?: ReactNode; centerSlot?: ReactNode; rightSlot?: ReactNode }) {
  return (
    <header className="sticky top-0 z-[var(--z-header)] h-[var(--layout-header-platform)] border-b border-white/10 bg-slate-950/90 px-[var(--layout-content-padding)] backdrop-blur">
