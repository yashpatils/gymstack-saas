...
export function PageContainer({ children }: { children: ReactNode }) {
  return <div className="mx-auto w-full max-w-[var(--layout-content-max-width)] space-y-[var(--space-xl)] px-[var(--layout-content-padding)] py-[var(--space-xl)]">{children}</div>;
}
