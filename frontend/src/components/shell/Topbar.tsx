  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-white/5 backdrop-blur-xl">
      <div className="px-4 md:px-6">
        ...
        <div className="grid h-12 grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-2 md:h-14 md:gap-3">
          <div className="flex min-w-0 items-center gap-2 justify-self-start whitespace-nowrap">
            <button
              type="button"
          ...
          <div className="flex min-w-0 items-center justify-center justify-self-center">
            {canSwitchMode ? (
              <div className="flex items-center gap-1 rounded-xl border border-border/70 bg-slate-900/40 p-1 text-xs whitespace-nowrap">
